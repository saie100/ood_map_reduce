...
Executive::Executive(int argumentCount, char **arguments) {
  this->argumentCount =
      argumentCount;  // initialize member variable "argumentCount"
  setArguments(this->argumentCount,
               arguments);  // initialize member variable "arguemnts"
};
...
vector<string> Executive::getArguments() { return this->arguments; }

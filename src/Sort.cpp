...
bool Sort::UpdateWordCounts(const string& input_filename, map<string, vector<int>>& word_counts) {
...
void Sort::SortCountsToFile(const map<string, vector<int>>& word_counts, ofstream& outfile) {
